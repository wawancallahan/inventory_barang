...
Public Class PenerimaanReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "InvetoryBarang.PenerimaanReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPenerimaanReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PenerimaanReport = New PenerimaanReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
