...
Public Class PermintaanReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "InvetoryBarang.PermintaanReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPermintaanReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PermintaanReport = New PermintaanReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
