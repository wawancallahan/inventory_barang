...
Public Class PengirimanReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "InvetoryBarang.PengirimanReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPengirimanReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PengirimanReport = New PengirimanReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
